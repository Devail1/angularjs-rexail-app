...
store.controller(
  ...
  function (
    ...
    ctrl.onLoadMore = function () {
      ctrl.state.paginationLimit =
        ctrl.state.paginationLimit + ctrl.state.paginationStep;
    };
    ...
    ctrl.onProductsSortBy = function (value) {
      ...
      if (value === "שם מוצר")
        $rootScope.globalState.selectedCategory.children = $filter("orderBy")(
          $rootScope.globalState.selectedCategory.children,
          "-name",
          true
        );
